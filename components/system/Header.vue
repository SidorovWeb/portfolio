<template>
  <div class="header">
    ...
    <div class="header__developer">
      <a href="https://vk.com/sidorovalexandern" target="_blank" class="header__link animColor">
        {{ this.$t("dev") }}
      </a>
    </div>
    <!-- SVGadmin -->
    ...
    <no-ssr>
      <div class="flags header__flags">
        <!-- SVGflagUS -->
        <span v-if="lang" class="flag" href="#" @click="classMonitoring(), changeLanguage('us')">
          <SVGflagUS />
        </span>
        <!-- SVGflagRU -->
        <span v-if="!lang" class="flag" href="#" @click="classMonitoring(), changeLanguage('ru')">
          <SVGflagRU />
        </span>
      </div>
    </no-ssr>

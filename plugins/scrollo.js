...
const scrollo = function() {
  ...
  let portfolioSvgWrapper = document.querySelectorAll(".portfolio__svg-wrapper")
  ...
  let contactsForm = document.querySelectorAll(".form")
  //social
  ...
  playcontacts
    ...
    .set([contactsForm, contactsText, cocialLink], { autoAlpha: 0 })
    .staggerTo(contactsTitleW, 0.8, { yPercent: 0, ease: Expo.inOut }, 0.5)
    .to([contactsForm, contactsText, cocialLink], 0.7, {
      autoAlpha: 1,
      ease: Power2.inOut
    })
  ...
  function reverseAnimation() {
    ...
    if (contacts.classList.contains("active-scroller-section")) {
      TweenMax.to([contactsForm, contactsText, cocialLink], 0.7, {
        autoAlpha: 0,
        ease: Power2.inOut
      })
      TweenMax.staggerTo(
